...
public class CoursePostsFragment extends BasePostListFragment {
    ...
    public PostLoader.MethodList getPostLoaderMethodList() {
        ...
        PostLoader.Method baseMethod = new PostLoader.Method(PostLoader.SOURCE_COURSE);
        ...
        method = new PostLoader.Method(PostLoader.SOURCE_HIGHLIGHT_COURSE);
        method.id = baseMethod.id;
