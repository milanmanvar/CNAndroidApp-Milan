 ...
 */
public class TaskFullScreen extends NavigationActivity {
    WebView txtContent;
            ...
            txtContent.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if (url.contains("data-taskactionlink-type=create_post")) {
                        ...
                        Intent intent = new Intent(TaskFullScreen.this, CreatePostActivity.class);
                        ...
                        CourseStore.getCourseContentPage(dataId, new ResponseCallback() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                Intent iDetail = new Intent(TaskFullScreen.this, TaskLinkDetail.class);
...
//        actionBar.setTitle("Task");
    ...
    public TaskFullScreen getNavigationActivity() {
        return (TaskFullScreen) this;
    }
