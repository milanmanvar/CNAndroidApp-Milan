...
/**
 * Downloaded from http://developer.android.com/samples/SwipeRefreshListFragment/index.html
 * for use in CNAndroid app.  All credit to original author.
 */
...
public abstract class SwipeRefreshListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Changed by PJ Heebner
        // get subclass's view.  If no view specified, get the result of the superclass's method
        View listFragmentView = getRootView(inflater, container, savedInstanceState);
    ...
    /**
     * Added by PJ Heebner
     * Allows subclasses to specify their own view hierarchy
     * @return A view, or null if no custom layout given
     */
    ...
    public void setRefreshing(final boolean refreshing) {
        //changed by PJ Heebner to post a runnable
